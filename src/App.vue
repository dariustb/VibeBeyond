<template>
  ...
  <div
    v-show="startPage"
    class="flex items-center justify-center h-screen shadow-[inset_0_0px_0px_1000px_rgba(217,217,217,0.2)]"
  >
    <!-- vibe beyond title -->
  ...
  <div v-show="playingPage">
    ...
    <button
      v-show="buttonsForTesting"
      @click="togglePlayingPage()"
      class="absolute top-72 left-72"
    >
